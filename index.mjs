...
async function cmdLs(args) {
  ...
  if (path && rest.length) throw new UsageError(`--path applies to the workspace listing, not ${rest[0]}\n  maw herdr ls --path`);
  if (rest[0] === '--agents') {
    rest.shift();
...
try {
  ...
  else if (command !== 'serve' && wantsHelp(command, args)) console.log(HELP);
