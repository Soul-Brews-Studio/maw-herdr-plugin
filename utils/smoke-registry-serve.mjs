...
const home=realpathSync(mkdtempSync(join(tmpdir(),'herdr-registry-smoke-')));
...
try{
 ...
 console.log('PASS registry wake ('+(native?'native':'bun')+'): auth/no-mutation, exact names, ambiguity, create/reuse, concurrent dedup, readiness failure');
